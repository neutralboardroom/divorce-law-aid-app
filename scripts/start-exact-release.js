...
const applicationRoot = path.join(repositoryRoot, '.runtime', 'divorce-law-aid-v0.90.0');
...
if (environment.RENDER === 'true') {
  ...
  environment.DLA_RELEASE_CANDIDATE_ID = environment.DLA_RELEASE_CANDIDATE_ID || `DLA-0.90.0-${commit ? commit.slice(0, 12) : 'RENDER'}`;
}
